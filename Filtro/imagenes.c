...
int lee_ppm(char *nomfich, struct pixel ***img, int *nf, int *nc) // nf = height; nc = width
{
  FILE *df;
  char tipo[MAXCAD];
...
int escribe_ppm(char *nomfich, struct pixel **img, int nf, int nc) // nf = height; nc = width
{
  FILE *df;
  int nivmax = 255, i, j;
